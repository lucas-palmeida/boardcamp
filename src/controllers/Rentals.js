...
export async function closeRental(req, res) {
    ...
    try {
        ...
        const returnDate = dayjs(), diffDays = returnDate.diff(getRental.rows[0].rentDate, 'day'), delayFee = diffDays > getRental.rows[0].daysRented ? diffDays * getGame.rows[0].pricePerDay : 0;
